...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "sxpafmgj2u350dgffgwwn14swmzvcvyp2tggwf2fmef1puzzs320",
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "8000", "--", "/opt/app/gotify"],
  environ = [
    (key = "PATH", value = "/usr/local/bin:/usr/bin:/bin"),
    (key = "SANDSTORM", value = "1"),

    (key = "GOTIFY_SERVER_PORT", value = "8000"),
    (key = "GOTIFY_DATABASE_DIALECT", value = "sqlite3"),
    (key = "GOTIFY_DATABASE_CONNECTION", value = "/var/gotify.db"),
    (key = "GOTIFY_PLUGINSDIR", value = "/var/plugins"),
    (key = "GOTIFY_UPLOADEDIMAGESDIR", value = "/var/images"),
    (key = "GOTIFY_REGISTRATION", value = "true"),
  ],
);
